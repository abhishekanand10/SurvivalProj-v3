...
<div class="container">
	<button type="button" class="btn btn-danger" style="position: absolute; top: 2%; right: 2%; border: 0;"><a href="index.html" style="text-decoration:none;">Log Out!</a></button>
		<button type="button" class="btn btn-primary" style="position: absolute; top: 2%; right: 8.5%; border: 0;"><a href="display-view.jsp" style="text-decoration:none;color:White">Transaction History</a></button>
