...
<button type="button" class="btn btn-danger" style="position: absolute; top: 2%; right: 2%; border: 0;"><a href="index.html" style="text-decoration:none;color:white">Log Out</a></button>
	<button type="button" class="btn btn-primary" style="position: absolute; top: 2%; right: 8%; border: 0;"><a href="TraderLandingPage.jsp" style="text-decoration:none;color:White">View Orders</a></button>
